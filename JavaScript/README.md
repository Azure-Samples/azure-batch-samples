...
The set of scripts provided in the [GettingStarted](GettingStarted) folder is a sample of creating Azure Batch jobs using the JavaScript SDK.
...
Also modify the [processcsv.py](GettingStarted/processcsv.py) with your storage account credentials that contain the csv files for conversion.
